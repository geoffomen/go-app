...
func NewGorm(dbConfig GormConfig, logger GormLogger) (*GormDb, error) {
	switch dbConfig.Dialect {
	case "mysql":
		return newMysql(dbConfig, logger)
	case "sqlite":
...
func newMysql(dbConfig GormConfig, logger GormLogger) (*GormDb, error) {
