...
if [ ! -f /workspace/configs/container_${APP_NAME}.yml ]; then
	cp -r /opt/${APP_NAME}/configs/container_${APP_NAME}.yml /workspace/configs/container_${APP_NAME}.yml
fi
...
if [ ! -f /workspace/deployments/container/compose.yml ]; then
	cp /workspace/deployments/container/docker_compose_${APP_NAME}.yml /workspace/deployments/container/compose.yml
fi
